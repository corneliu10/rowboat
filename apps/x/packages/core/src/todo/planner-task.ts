...
9. Phrase each item the way the user would write it — short, concrete, starting with a verb. Include @spinball in the text ONLY to offer internal prep you could do yourself (research, outline, compile, summarize — never anything outward-facing); it waits for the user's go either way.
...
7. Phrase each item the way the user would write it — short, concrete, starting with a verb. Include @spinball in the text ONLY to offer internal prep you could do yourself (research, outline, compile, summarize — never anything outward-facing); it waits for the user's go either way.`;
...
8. Phrase each item the way the user would write it — short, concrete, starting with a verb. Include @spinball in the text ONLY to offer internal prep you could do yourself (research, outline, compile, summarize — never anything outward-facing); it waits for the user's go either way.
